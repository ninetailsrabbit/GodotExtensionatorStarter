...
#pragma warning restore CS0109
    ...
    protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
    {
        ...
        if (method == MethodName.TransitionToScene && args.Count == 4) {
            TransitionToScene(global::Godot.NativeInterop.VariantUtils.ConvertTo<string>(args[0]), global::Godot.NativeInterop.VariantUtils.ConvertTo<bool>(args[1]), global::Godot.NativeInterop.VariantUtils.ConvertTo<global::GodotExtensionatorStarter.SceneTransitionManager.TRANSITIONS>(args[2]), global::Godot.NativeInterop.VariantUtils.ConvertTo<global::GodotExtensionatorStarter.SceneTransitionManager.TRANSITIONS>(args[3]));
            ret = default;
            return true;
        }
        ...
        if (method == MethodName.PrepareTransitionAnimations && args.Count == 3) {
            PrepareTransitionAnimations(global::Godot.NativeInterop.VariantUtils.ConvertTo<bool>(args[0]), global::Godot.NativeInterop.VariantUtils.ConvertTo<global::GodotExtensionatorStarter.SceneTransitionManager.TRANSITIONS>(args[1]), global::Godot.NativeInterop.VariantUtils.ConvertTo<global::GodotExtensionatorStarter.SceneTransitionManager.TRANSITIONS>(args[2]));
            ret = default;
            return true;
        }
        if (method == MethodName.AnimationNameFromTransition && args.Count == 1) {
            var callRet = AnimationNameFromTransition(global::Godot.NativeInterop.VariantUtils.ConvertTo<global::GodotExtensionatorStarter.SceneTransitionManager.TRANSITIONS>(args[0]));
