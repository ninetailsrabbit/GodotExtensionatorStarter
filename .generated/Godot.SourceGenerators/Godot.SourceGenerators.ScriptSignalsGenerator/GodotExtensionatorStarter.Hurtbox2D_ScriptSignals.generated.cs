...
partial class Hurtbox2D
{
#pragma warning disable CS0109 // Disable warning about redundant 'new' keyword
    /// <summary>
    /// Cached StringNames for the signals contained in this class, for fast lookup.
    /// </summary>
    public new class SignalName : global::Godot.Area2D.SignalName {
        /// <summary>
    ...
    internal new static global::System.Collections.Generic.List<global::Godot.Bridge.MethodInfo> GetGodotSignalList()
    {
        ...
        signals.Add(new(name: SignalName.HitboxDetected, returnVal: new(type: (global::Godot.Variant.Type)0, name: "", hint: (global::Godot.PropertyHint)0, hintString: "", usage: (global::Godot.PropertyUsageFlags)6, exported: false), flags: (global::Godot.MethodFlags)1, arguments: new() { new(type: (global::Godot.Variant.Type)24, name: "hitbox", hint: (global::Godot.PropertyHint)0, hintString: "", usage: (global::Godot.PropertyUsageFlags)6, exported: false, className: new global::Godot.StringName("Area2D")),  }, defaultArguments: null));
        return signals;
    }
#pragma warning restore CS0109
    private global::GodotExtensionatorStarter.Hurtbox2D.HitboxDetectedEventHandler backing_HitboxDetected;
    /// <inheritdoc cref="global::GodotExtensionatorStarter.Hurtbox2D.HitboxDetectedEventHandler"/>
    public event global::GodotExtensionatorStarter.Hurtbox2D.HitboxDetectedEventHandler HitboxDetected {
    ...
    protected override void RaiseGodotClassSignalCallbacks(in godot_string_name signal, NativeVariantPtrArgs args)
    {
        if (signal == SignalName.HitboxDetected && args.Count == 1) {
            backing_HitboxDetected?.Invoke(global::Godot.NativeInterop.VariantUtils.ConvertTo<global::GodotExtensionatorStarter.Hitbox2D>(args[0]));
            return;
        }
